...
"There are also certain parameters which are not really features,\n"
"but must be entered in as decimal or hexadecimal numbers or\n"
"possibly text.\n"
"\n"
...
"keys and press <Y> to build it in, or <N> to remove it.\n"
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	/* HACK!  Busybox's kconfig doesn't have
	 * conf_get_configname like Linux's does.
	 * So we need to force it here, even if
	 * it's not true...
	 */
	sprintf(menu_backtitle, _(".config - %s"),
